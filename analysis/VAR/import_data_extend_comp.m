function [vars_select, topics_returns, dates, dependent_abs, dependent_logs, explan_topics_comp_sent, explan_vars_topics_sent, sentiment] = import_data_extend_comp(file)
