function [vars_select, topics_returns, dates, dependent_abs, dependent_logs, explan_vars_topics, explan_topics_comp_sent, explan_vars_topics_sent, sentiment] = import_data_comp(file)
    ...
    explan_vars_topics = table2array(vars_select(:, 3:22));       % only the components based on topics {Component1,..,Component20}
    explan_topics_comp_sent = table2array(vars_select(:, (end-9):end));
